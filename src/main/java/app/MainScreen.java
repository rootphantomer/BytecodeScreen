...
//                }
    ...
    public static HashSet<String> targetclass(List<String> resultlist, String methodname, String methodparam,
                                              String methodreturn) {
    ...
    public static HashSet<String> tarclass(HashMap<String, List<String>> hashSet1,
                                           HashMap<String, List<String>> hashSet2,
                                           HashMap<String, List<String>> hashSet3,
                                           HashMap<String, List<String>> hashSet4) {
        HashSet<String> result = new HashSet<>();
    ...
    private static void inherit() {
        InheritanceMap inheritanceMap = InheritanceService.start(classMap);//key是每一个类classReference.getHandle,
        // value是一个key为每一个class.handle,value其父类或者接口类handle的set集合
